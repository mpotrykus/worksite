	<div id="navContainer1">
		<div id="navContainer">
			...
			<ul>
				...
				<ul class="dropdown">
					<a href="products.php" class="navItem dropbtn">Products</a>
						<div class="dropdown-content">
							<li class="dropdown1">
							...
							<a class="dropLink" href="productsListings.php?productSort=NA%20Beer&start=0&per_page=50&brand=">NA Beer</a>
							<a class="dropLink" href="productsListings.php?productSort=LiquorWine&start=0&per_page=50&brand=">Liquor/Wine</a>
							<a class="dropLink" href="productsListings.php?productSort=Dry%20Goods&start=0&per_page=50&brand=">Dry Goods</a>
